...
<html>
	<head>
		...
		<script language="Javascript">
			...
			function Select()
			{
				window.opener.form_admin.p_area_id.value = document.form_query.p_area_id.options[document.form_query.p_area_id.options.selectedIndex].value;
