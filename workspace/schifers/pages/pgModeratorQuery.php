...
<html>
	<head>
		...
		<script language="Javascript">
			...
			function Select()
			{
				window.opener.form_admin.p_modr_id.value = document.form_query.p_modr_id.options[document.form_query.p_modr_id.options.selectedIndex].value;
