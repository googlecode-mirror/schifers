...
<html>
	<head>
		...
		<script language="Javascript">
			...
			function Select()
			{
				window.opener.form_admin.p_modu_id.value = document.form_query.p_modu_id.options[document.form_query.p_modu_id.options.selectedIndex].value;
