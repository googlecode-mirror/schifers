...
<html>
	<head>
		...
		<script language="Javascript">
			...
			function Select()
			{
				window.opener.form_admin.p_subj_id.value = document.form_query.p_subj_id.options[document.form_query.p_subj_id.options.selectedIndex].value;
